...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def _load_settings(extra: Dict[str, Any]) -> FeishuAdapterSettings:
        ...
        return FeishuAdapterSettings(
            ...
            use_card=_to_boolean(extra.get("use_card", os.getenv("FEISHU_USE_CARD", "true"))),
    ...
    def _apply_settings(self, settings: FeishuAdapterSettings) -> None:
        ...
        self._use_card = settings.use_card
    ...
    def _build_card_payload(content: str) -> str:
        """Build a Feishu interactive card payload from text content.

        Wraps the content in a ``schema: "2.0"`` card with a single markdown
        element, matching the GenericAgent card format.  Sent as
        ``msg_type="interactive"``.
        """
        return json.dumps(
            {
